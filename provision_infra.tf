...
resource "openstack_networking_router_v2" "router_1" {
  name = "web-router"
  external_network_id = "0dc30001-edfb-4137-be76-8e51f38fd650"
}
...
#     command = "ANSIBLE_HOST_KEY_CHECKING=False ansible-playbook -i openstack.yml -l ${data.openstack_compute_instance_v2.web_vm_data[each.key].name} deploy_webserver.yaml"
#   }
# }
